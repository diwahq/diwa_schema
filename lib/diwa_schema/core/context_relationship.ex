defmodule DiwaSchema.Core.ContextRelationship do
  ...
  @derive {Jason.Encoder, only: [:id, :source_context_id, :target_context_id, :relationship_type, :metadata, :inserted_at]}
  ...
  def changeset(relationship, attrs) do
    ...
    |> check_loop()
    |> unique_constraint([:source_context_id, :target_context_id, :relationship_type], name: "context_relationships_source_context_id_target_context_id_relat")
  end
