defmodule DiwaSchema.Core.Context do
  ...
  schema "contexts" do
    ...
    has_many(:outgoing_relationships, DiwaSchema.Core.ContextRelationship,
      foreign_key: :source_context_id
    )

    has_many(:incoming_relationships, DiwaSchema.Core.ContextRelationship,
      foreign_key: :target_context_id
    )
